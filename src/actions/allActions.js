...
// Match Data Actions
export const MATCH_LIST_FETCH_REQUESTED = 'MATCH_LIST_FETCH_REQUESTED'; 
export const MATCH_LIST_FETCH_SUCCEEDED = 'MATCH_LIST_FETCH_SUCCEEDED'; 
export const MATCH_LIST_FETCH_FAILED = 'MATCH_LIST_FETCH_FAILED'; 

export const MATCH_DATA_FETCH_REQUESTED = 'MATCH_DATA_FETCH_REQUESTED'; 
export const MATCH_DATA_FETCH_SUCCEEDED = 'MATCH_DATA_FETCH_SUCCEEDED'; 
export const MATCH_DATA_FETCH_FAILED = 'MATCH_DATA_FETCH_FAILED'; 
